...
public class GenerateracipesProcedure {
	public static void execute(LevelAccessor world, HashMap guistate) {
		if (guistate == null)
			return;
		JustCtguiModVariables.Pre_generated_recipe = (guistate.containsKey("checkbox:Is_shapeless") ? ((Checkbox) guistate.get("checkbox:Is_shapeless")).selected() : false)
		...
		JustCtguiModVariables.Generated_recipe = ((guistate.containsKey("checkbox:Is_mirrored") ? ((Checkbox) guistate.get("checkbox:Is_mirrored")).selected() : false)
				? "import crafttweaker.api.recipe.MirrorAxis;" + "craftingTable.addShapedMirrored(\""
				: "")
				+ "" + ((guistate.containsKey("checkbox:Is_shapeless") ? ((Checkbox) guistate.get("checkbox:Is_shapeless")).selected() : false) ? "craftingTable.addShapeless(\"" : "")
				+ (!((guistate.containsKey("checkbox:Is_mirrored") ? ((Checkbox) guistate.get("checkbox:Is_mirrored")).selected() : false)
						|| (guistate.containsKey("checkbox:Is_shapeless") ? ((Checkbox) guistate.get("checkbox:Is_shapeless")).selected() : false)) ? "craftingTable.addShaped(\"" : "")
				...
				+ "\", " + ((guistate.containsKey("checkbox:Is_mirrored") ? ((Checkbox) guistate.get("checkbox:Is_mirrored")).selected() : false) ? JustCtguiModVariables.Mirror_axis + ", " : "") + JustCtguiModVariables.Pre_generated_recipe;
