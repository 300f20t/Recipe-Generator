...
public record FurnaceCTGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(JustCtguiMod.MODID, "furnace_ctgui_buttons");
	...
	public static void handleData(final FurnaceCTGUIButtonMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(FurnaceCTGUIButtonMessage.ID, FurnaceCTGUIButtonMessage::new, FurnaceCTGUIButtonMessage::handleData);
	}
}
