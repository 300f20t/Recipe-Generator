...
public class CraftingTableRemovingCTGUISlotMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(CraftingTableRemovingCTGUISlotMessage.class, CraftingTableRemovingCTGUISlotMessage::buffer, CraftingTableRemovingCTGUISlotMessage::new, CraftingTableRemovingCTGUISlotMessage::handler);
	}
}
