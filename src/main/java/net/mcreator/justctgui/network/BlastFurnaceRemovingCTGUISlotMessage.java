...
public record BlastFurnaceRemovingCTGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<BlastFurnaceRemovingCTGUISlotMessage> TYPE = new Type<>(new ResourceLocation(JustCtguiMod.MODID, "blast_furnace_removing_ctgui_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(BlastFurnaceRemovingCTGUISlotMessage.TYPE, BlastFurnaceRemovingCTGUISlotMessage.STREAM_CODEC, BlastFurnaceRemovingCTGUISlotMessage::handleData);
	}
}
