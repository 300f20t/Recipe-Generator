...
public record BlastFurnaceRemovingCTGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final ResourceLocation ID = new ResourceLocation(JustCtguiMod.MODID, "blast_furnace_removing_ctgui_slots");
	...
	public static void handleData(final BlastFurnaceRemovingCTGUISlotMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(BlastFurnaceRemovingCTGUISlotMessage.ID, BlastFurnaceRemovingCTGUISlotMessage::new, BlastFurnaceRemovingCTGUISlotMessage::handleData);
	}
}
