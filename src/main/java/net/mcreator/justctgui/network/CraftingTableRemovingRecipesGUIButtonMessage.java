...
public class CraftingTableRemovingRecipesGUIButtonMessage {
	...
	public CraftingTableRemovingRecipesGUIButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void buffer(CraftingTableRemovingRecipesGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(CraftingTableRemovingRecipesGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(CraftingTableRemovingRecipesGUIButtonMessage.class, CraftingTableRemovingRecipesGUIButtonMessage::buffer, CraftingTableRemovingRecipesGUIButtonMessage::new,
				CraftingTableRemovingRecipesGUIButtonMessage::handler);
	}
}
