...
public record CraftingtableCTGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<CraftingtableCTGUISlotMessage> TYPE = new Type<>(new ResourceLocation(JustCtguiMod.MODID, "craftingtable_ctgui_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(CraftingtableCTGUISlotMessage.TYPE, CraftingtableCTGUISlotMessage.STREAM_CODEC, CraftingtableCTGUISlotMessage::handleData);
	}
}
