...
public record BlastFurnaceCTGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {
	...
	public static final Type<BlastFurnaceCTGUISlotMessage> TYPE = new Type<>(new ResourceLocation(JustCtguiMod.MODID, "blast_furnace_ctgui_slots"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(BlastFurnaceCTGUISlotMessage.TYPE, BlastFurnaceCTGUISlotMessage.STREAM_CODEC, BlastFurnaceCTGUISlotMessage::handleData);
	}
}
