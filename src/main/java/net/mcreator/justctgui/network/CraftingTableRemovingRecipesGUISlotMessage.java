...
public record CraftingTableRemovingRecipesGUISlotMessage(int slotID, int x, int y, int z, int changeType, int meta) implements CustomPacketPayload {

	public static final ResourceLocation ID = new ResourceLocation(JustCtguiMod.MODID, "crafting_table_removing_recipes_gui_slots");
	...
	public static void handleData(final CraftingTableRemovingRecipesGUISlotMessage message, final PlayPayloadContext context) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(CraftingTableRemovingRecipesGUISlotMessage.ID, CraftingTableRemovingRecipesGUISlotMessage::new, CraftingTableRemovingRecipesGUISlotMessage::handleData);
	}
}
