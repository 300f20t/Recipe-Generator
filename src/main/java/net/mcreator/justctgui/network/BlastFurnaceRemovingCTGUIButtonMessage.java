...
public record BlastFurnaceRemovingCTGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<BlastFurnaceRemovingCTGUIButtonMessage> TYPE = new Type<>(new ResourceLocation(JustCtguiMod.MODID, "blast_furnace_removing_ctgui_buttons"));
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		JustCtguiMod.addNetworkMessage(BlastFurnaceRemovingCTGUIButtonMessage.TYPE, BlastFurnaceRemovingCTGUIButtonMessage.STREAM_CODEC, BlastFurnaceRemovingCTGUIButtonMessage::handleData);
	}
}
