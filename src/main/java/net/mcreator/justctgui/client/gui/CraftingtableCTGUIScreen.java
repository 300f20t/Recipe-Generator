...
public class CraftingtableCTGUIScreen extends AbstractContainerScreen<CraftingtableCTGUIMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (ATTENTIONProcedure.execute())
			if (mouseX > leftPos + -121 && mouseX < leftPos + -97 && mouseY > topPos + 129 && mouseY < topPos + 153)
				this.renderTooltip(ms, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.tooltip_attention_this_configuration_wil"), mouseX, mouseY);
	}
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.label_recipe_name"), -123, -3, -3355393);
		this.font.draw(poseStack, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.label_file_name"), -123, 33, -3355393);
		this.font.draw(poseStack, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.label_empty"), -119, -39, -4610825);
	}
	...
	public void init() {
		...
		recipe_name = new EditBox(this.font, this.leftPos + -123, this.topPos + 7, 120, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.recipe_name")) {
			{
				setSuggestion(new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.recipe_name").getString());
			}
		...
		file_name = new EditBox(this.font, this.leftPos + -123, this.topPos + 43, 120, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.file_name")) {
			{
				setSuggestion(new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.file_name").getString());
			}
		...
		button_all = new Button(this.leftPos + -119, this.topPos + -29, 40, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_all"), e -> {
			if (true) {
		...
		button_diagonal = new Button(this.leftPos + 114, this.topPos + -29, 67, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_diagonal"), e -> {
			if (true) {
		...
		button_horizontal = new Button(this.leftPos + 15, this.topPos + -29, 77, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_horizontal"), e -> {
			if (true) {
		...
		button_none = new Button(this.leftPos + -56, this.topPos + -29, 46, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_none"), e -> {
			if (true) {
		...
		button_vertical = new Button(this.leftPos + 204, this.topPos + -29, 67, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_vertical"), e -> {
			if (true) {
		...
		button_generate = new Button(this.leftPos + 186, this.topPos + 7, 67, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_generate"), e -> {
			if (true) {
		...
		button_save = new Button(this.leftPos + 186, this.topPos + 34, 46, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_save"), e -> {
			if (true) {
		...
		button_close = new Button(this.leftPos + 186, this.topPos + 61, 51, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.button_close"), e -> {
			if (true) {
		...
		Is_shapeless = new Checkbox(this.leftPos + -119, this.topPos + 97, 20, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.Is_shapeless"), false);
		guistate.put("checkbox:Is_shapeless", Is_shapeless);
		this.addRenderableWidget(Is_shapeless);
		Is_mirrored = new Checkbox(this.leftPos + -119, this.topPos + 70, 20, 20, new TranslatableComponent("gui.just_ctgui.craftingtable_ctgui.Is_mirrored"), false);
