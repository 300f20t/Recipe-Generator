...
public class BlastFurnaceCTGUIScreen extends AbstractContainerScreen<BlastFurnaceCTGUIMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("just_ctgui:textures/screens/blast_furnace_ctgui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.label_recipe_name"), -129, -2, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.label_file_name"), -129, 34, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.label_xp"), -129, 88, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.label_time"), -129, 133, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.label_furnace"), 69, 7, -12829636, false);
	}

	@Override
	public void init() {
		super.init();
		recipe_name = new EditBox(this.font, this.leftPos + -128, this.topPos + 8, 118, 18, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.recipe_name")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.recipe_name").getString());
				else
					setSuggestion(null);
			}
		...
		recipe_name.setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.recipe_name").getString());
		guistate.put("text:recipe_name", recipe_name);
		this.addWidget(this.recipe_name);
		file_name = new EditBox(this.font, this.leftPos + -128, this.topPos + 44, 118, 18, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.file_name")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.file_name").getString());
				else
					setSuggestion(null);
			}
		...
		file_name.setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.file_name").getString());
		guistate.put("text:file_name", file_name);
		this.addWidget(this.file_name);
		XP = new EditBox(this.font, this.leftPos + -128, this.topPos + 98, 118, 18, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.XP")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.XP").getString());
				else
					setSuggestion(null);
			}
		...
		XP.setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.XP").getString());
		guistate.put("text:XP", XP);
		this.addWidget(this.XP);
		time = new EditBox(this.font, this.leftPos + -128, this.topPos + 143, 118, 18, Component.translatable("gui.just_ctgui.blast_furnace_ctgui.time")) {
			@Override
			public void insertText(String text) {
				super.insertText(text);
				if (getValue().isEmpty())
					setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.time").getString());
				else
					setSuggestion(null);
			}
		...
		time.setSuggestion(Component.translatable("gui.just_ctgui.blast_furnace_ctgui.time").getString());
