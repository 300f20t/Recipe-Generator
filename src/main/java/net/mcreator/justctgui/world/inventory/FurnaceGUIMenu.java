...
import net.mcreator.justctgui.network.FurnaceGUISlotMessage;
...
public class FurnaceGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			JustCtguiMod.PACKET_HANDLER.sendToServer(new FurnaceGUISlotMessage(slotid, x, y, z, ctype, meta));
			FurnaceGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
