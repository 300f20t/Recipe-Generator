...
public class FurnaceCTGUIMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public FurnaceCTGUIMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
