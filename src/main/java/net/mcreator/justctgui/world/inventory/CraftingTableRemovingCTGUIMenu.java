...
public class CraftingTableRemovingCTGUIMenu extends Container implements Supplier<Map<Integer, Slot>> {
	...
	public CraftingTableRemovingCTGUIMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
