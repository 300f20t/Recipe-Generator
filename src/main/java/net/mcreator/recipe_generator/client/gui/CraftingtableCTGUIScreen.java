...
public class CraftingtableCTGUIScreen extends AbstractContainerScreen<CraftingtableCTGUIMenu> {
	...
	public void render(PoseStack ms, int mouseX, int mouseY, float partialTicks) {
		...
		if (ATTENTIONProcedure.execute())
			if (mouseX > leftPos + 240 && mouseX < leftPos + 264 && mouseY > topPos + 34 && mouseY < topPos + 58)
				this.renderTooltip(ms, Component.translatable("gui.recipe_generator.craftingtable_ctgui.tooltip_attention_this_configuration_wil"), mouseX, mouseY);
	}
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		RenderSystem.setShaderTexture(0, new ResourceLocation("recipe_generator:textures/screens/crafting_table.png"));
		this.blit(ms, this.leftPos + 90, this.topPos + 34, 0, 0, 24, 17, 24, 17);

		if (ATTENTIONProcedure.execute()) {
			RenderSystem.setShaderTexture(0, new ResourceLocation("recipe_generator:textures/screens/popup_hint.png"));
			this.blit(ms, this.leftPos + 240, this.topPos + 34, 0, 0, 24, 24, 24, 24);
		}
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_recipe_name"), -129, -2, -3355393);
		this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_file_name"), -129, 34, -3355393);
		this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_empty"), -124, -35, -3355393);
		this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_current_axis"), 0, -35, -3355393);
		this.font.draw(poseStack,

				GetCurrentAxisProcedure.execute(), 68, -35, -3355393);
		this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_crafting"), 24, 5, -12829636);
		if (InvertedCheckKubeJSProcedure.execute())
			this.font.draw(poseStack, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_shapeless_and_mirrored_recipes_d"), -39, 169, -65485);
	}
	...
	public void init() {
		...
		button_all = new Button(this.leftPos + -124, this.topPos + -25, 40, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_all"), e -> {
			if (true) {
		...
		button_diagonal = new Button(this.leftPos + 39, this.topPos + -25, 67, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_diagonal"), e -> {
			if (true) {
		...
		button_horizontal = new Button(this.leftPos + -38, this.topPos + -25, 77, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_horizontal"), e -> {
			if (true) {
		...
		button_none = new Button(this.leftPos + -84, this.topPos + -25, 46, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_none"), e -> {
			if (true) {
		...
		button_vertical = new Button(this.leftPos + 106, this.topPos + -25, 67, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_vertical"), e -> {
			if (true) {
		...
		button_generate = new Button(this.leftPos + 186, this.topPos + 7, 67, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_generate"), e -> {
			if (true) {
		...
		button_save = new Button(this.leftPos + 186, this.topPos + 34, 46, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_save"), e -> {
			if (true) {
		...
		button_close = new Button(this.leftPos + 186, this.topPos + 142, 51, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_close"), e -> {
			if (true) {
		...
		button_reload = new Button(this.leftPos + 186, this.topPos + 61, 56, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_reload"), e -> {
			if (true) {
