...
public class CraftingtableCTGUIScreen extends AbstractContainerScreen<CraftingtableCTGUIMenu> {
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_recipe_name"), -128, -2, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_file_name"), -128, 34, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_empty"), -123, -35, -3355393, false);
		...
		if (InvertedCheckKubeJSProcedure.execute())
			guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.craftingtable_ctgui.label_shapeless_and_mirrored_recipes_d"), -38, 169, -65485, false);
	}
	...
	public void init() {
		super.init();
		recipe_name = new EditBox(this.font, this.leftPos + -128, this.topPos + 7, 120, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.recipe_name")) {
			{
		...
		file_name = new EditBox(this.font, this.leftPos + -128, this.topPos + 43, 120, 20, Component.translatable("gui.recipe_generator.craftingtable_ctgui.file_name")) {
			{
		...
		button_all = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_all"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_0"), new CraftingtableCTGUIButtonMessage(0, x, y, z));
			}
		...
		button_diagonal = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_diagonal"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_1"), new CraftingtableCTGUIButtonMessage(1, x, y, z));
			}
		...
		button_horizontal = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_horizontal"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_2"), new CraftingtableCTGUIButtonMessage(2, x, y, z));
			}
		...
		button_none = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_none"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_3"), new CraftingtableCTGUIButtonMessage(3, x, y, z));
			}
		...
		button_vertical = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_vertical"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_4"), new CraftingtableCTGUIButtonMessage(4, x, y, z));
			}
		...
		button_generate = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_generate"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_5"), new CraftingtableCTGUIButtonMessage(5, x, y, z));
			}
		...
		button_save = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_save"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_6"), new CraftingtableCTGUIButtonMessage(6, x, y, z));
			}
		...
		button_close = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_close"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_7"), new CraftingtableCTGUIButtonMessage(7, x, y, z));
			}
		...
		button_reload = Button.builder(Component.translatable("gui.recipe_generator.craftingtable_ctgui.button_reload"), e -> {
			if (true) {
				ClientPlayNetworking.send(new ResourceLocation(RecipeGeneratorMod.MODID, "craftingtablectgui_button_8"), new CraftingtableCTGUIButtonMessage(8, x, y, z));
			}
