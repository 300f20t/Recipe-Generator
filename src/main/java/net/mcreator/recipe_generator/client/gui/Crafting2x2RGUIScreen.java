...
public class Crafting2x2RGUIScreen extends AbstractContainerScreen<Crafting2x2RGUIMenu> implements RecipeGeneratorModScreens.ScreenAccessor {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("recipe_generator:textures/screens/crafting_2x_2_rgui.png");
	...
	protected void renderLabels(GuiGraphics guiGraphics, int mouseX, int mouseY) {
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.label_recipe_name"), -120, -2, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.label_file_name"), -120, 34, -3355393, false);
		guiGraphics.drawString(this.font, Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.label_crafting"), 24, 5, -12829636, false);
	}
	...
	public void init() {
		...
		button_save = Button.builder(Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.button_save"), e -> {
			int x = Crafting2x2RGUIScreen.this.x;
			int y = Crafting2x2RGUIScreen.this.y;
			if (true) {
		...
		button_close = Button.builder(Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.button_close"), e -> {
			int x = Crafting2x2RGUIScreen.this.x;
			int y = Crafting2x2RGUIScreen.this.y;
			if (true) {
		...
		button_reload = Button.builder(Component.translatable("gui.recipe_generator.crafting_2x_2_rgui.button_reload"), e -> {
			int x = Crafting2x2RGUIScreen.this.x;
			int y = Crafting2x2RGUIScreen.this.y;
			if (true) {
