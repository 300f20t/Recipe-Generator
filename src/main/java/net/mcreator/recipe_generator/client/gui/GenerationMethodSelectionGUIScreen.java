...
public class GenerationMethodSelectionGUIScreen extends AbstractContainerScreen<GenerationMethodSelectionGUIMenu> implements WidgetScreen {
	...
	public static HashMap<String, String> getEditBoxAndCheckBoxValues() {
		...
		if (Minecraft.getInstance().screen instanceof GenerationMethodSelectionGUIScreen sc) {
	...
	public void init() {
		...
		button_crafttweaker = Button.builder(Component.translatable("gui.recipe_generator.generation_method_selection_gui.button_crafttweaker"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new GenerationMethodSelectionGUIButtonMessage(0, x, y, z, getEditBoxAndCheckBoxValues()));
				GenerationMethodSelectionGUIButtonMessage.handleButtonAction(entity, 0, x, y, z, getEditBoxAndCheckBoxValues());
			}
		...
		button_kubejs_wip = Button.builder(Component.translatable("gui.recipe_generator.generation_method_selection_gui.button_kubejs_wip"), e -> {
			if (true) {
				PacketDistributor.sendToServer(new GenerationMethodSelectionGUIButtonMessage(1, x, y, z, getEditBoxAndCheckBoxValues()));
				GenerationMethodSelectionGUIButtonMessage.handleButtonAction(entity, 1, x, y, z, getEditBoxAndCheckBoxValues());
			}
