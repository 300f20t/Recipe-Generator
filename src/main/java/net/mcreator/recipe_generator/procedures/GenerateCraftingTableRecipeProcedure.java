...
public class GenerateCraftingTableRecipeProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if ((RecipeGeneratorModVariables.WorldVariables.get(world).selectedMethod).equals("CraftTweaker")) {
			if ((entity instanceof Player _entity0 && _entity0.containerMenu instanceof RecipeGeneratorModMenus.MenuAccessor _menu0) && _menu0.getMenuState(1, "Is_shapeless", false)) {
				CraftingTableAddShapelessCraftTweakerProcedure.execute(entity);
			} else if ((entity instanceof Player _entity1 && _entity1.containerMenu instanceof RecipeGeneratorModMenus.MenuAccessor _menu1) && _menu1.getMenuState(1, "Is_mirrored", false)) {
			...
			if ((entity instanceof Player _entity2 && _entity2.containerMenu instanceof RecipeGeneratorModMenus.MenuAccessor _menu2) && _menu2.getMenuState(1, "Is_shapeless", false)) {
