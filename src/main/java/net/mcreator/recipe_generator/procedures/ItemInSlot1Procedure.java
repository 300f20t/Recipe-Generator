	...
	public static void execute(LevelAccessor world, Entity entity) {
		...
		RecipeGeneratorMod.queueServerWork(1, () -> {
			RecipeGeneratorModVariables.item_in_slot_1 = ItemsFormatProcedure.execute(world,
					entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof RecipeGeneratorModMenus.MenuAccessor _menu0 ? _menu0.getSlots().get(1).getItem() : ItemStack.EMPTY);
		});
	}
}