				...
				ServerTickEvents.END_SERVER_TICK.register((server) -> {
					...
					if (this.ticks == 1) {
						if ((RecipeGeneratorModVariables.selectedMethod).equals("CraftTweaker")) {
							RecipeGeneratorModVariables.item_in_slot_5 = "<item:"
							...
							RecipeGeneratorModVariables.item_in_slot_5 = "'" + (BuiltInRegistries.ITEM.getKey((entity instanceof ServerPlayer _plrSlotItem ? _plrSlotItem.containerMenu.getSlot(5).getItem() : ItemStack.EMPTY).getItem()).toString())
									+ "'";
						}
						return;
					}
