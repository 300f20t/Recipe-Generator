...
public class ItemInSlot9Procedure {
	public static void execute(LevelAccessor world, Entity entity, ItemStack inputItem) {
		if (entity == null)
			return;
		ItemsFormatProcedure.execute(world, entity instanceof Player _plrSlotItem && _plrSlotItem.containerMenu instanceof Supplier _splr && _splr.get() instanceof Map _slt ? ((Slot) _slt.get(9)).getItem() : ItemStack.EMPTY);
