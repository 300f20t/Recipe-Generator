...
public record ChoosingTheRecipeGeneratingMethodGUIWithCommandButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<ChoosingTheRecipeGeneratingMethodGUIWithCommandButtonMessage> TYPE = new Type<>(new ResourceLocation(RecipeGeneratorMod.MODID, "choosing_the_recipe_generating_method_gui_with_command_buttons"));
