...
public class BlastFurnaceCTGUISlotMessage extends FriendlyByteBuf {
	public BlastFurnaceCTGUISlotMessage(int slot, int x, int y, int z, int changeType, int meta) {
