...
public class FurnaceRemovingCTGUISlotMessage extends FriendlyByteBuf {
	public FurnaceRemovingCTGUISlotMessage(int slot, int x, int y, int z, int changeType, int meta) {
