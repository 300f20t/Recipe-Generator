...
public class BlastFurnaceRemovingCTGUISlotMessage extends FriendlyByteBuf {
	public BlastFurnaceRemovingCTGUISlotMessage(int slot, int x, int y, int z, int changeType, int meta) {
