...
public class BlastFurnaceCTGUIButtonMessage {
	...
	public BlastFurnaceCTGUIButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(BlastFurnaceCTGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BlastFurnaceCTGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		RecipeGeneratorMod.addNetworkMessage(BlastFurnaceCTGUIButtonMessage.class, BlastFurnaceCTGUIButtonMessage::buffer, BlastFurnaceCTGUIButtonMessage::new, BlastFurnaceCTGUIButtonMessage::handler);
	}
