...
public record ChoosingTheRecipeGenerationMethodGUIButtonMessage(int buttonID, int x, int y, int z) implements CustomPacketPayload {
	...
	public static final Type<ChoosingTheRecipeGenerationMethodGUIButtonMessage> TYPE = new Type<>(new ResourceLocation(RecipeGeneratorMod.MODID, "choosing_the_recipe_generation_method_gui_buttons"));
