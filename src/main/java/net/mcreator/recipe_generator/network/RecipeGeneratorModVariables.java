...
public class RecipeGeneratorModVariables {
	...
	public static class WorldVariables extends SavedData {
		...
		public boolean Is_mirrored = false;
		public boolean Is_shapeless = false;
		public String Mirror_axis = "NONE";
		...
		public void read(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			Is_mirrored = nbt.getBoolean("Is_mirrored");
			Is_shapeless = nbt.getBoolean("Is_shapeless");
			Mirror_axis = nbt.getString("Mirror_axis");
			selectedMethod = nbt.getString("selectedMethod");
		}

		@Override
		public CompoundTag save(CompoundTag nbt, HolderLookup.Provider lookupProvider) {
			nbt.putBoolean("Is_mirrored", Is_mirrored);
			nbt.putBoolean("Is_shapeless", Is_shapeless);
			nbt.putString("Mirror_axis", Mirror_axis);
