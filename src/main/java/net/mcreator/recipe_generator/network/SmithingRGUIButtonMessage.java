...
public class SmithingRGUIButtonMessage {
	...
	public static void handler(SmithingRGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			GenerateSmithingRacipesProcedure.execute(world, entity);
		}
		if (buttonID == 1) {
