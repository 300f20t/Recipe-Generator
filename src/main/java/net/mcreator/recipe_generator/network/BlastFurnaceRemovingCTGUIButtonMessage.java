...
public class BlastFurnaceRemovingCTGUIButtonMessage {
	...
	public BlastFurnaceRemovingCTGUIButtonMessage(int buttonID, int x, int y, int z, HashMap<String, String> textstate) {
	...
	public static void buffer(BlastFurnaceRemovingCTGUIButtonMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(BlastFurnaceRemovingCTGUIButtonMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		RecipeGeneratorMod.addNetworkMessage(BlastFurnaceRemovingCTGUIButtonMessage.class, BlastFurnaceRemovingCTGUIButtonMessage::buffer, BlastFurnaceRemovingCTGUIButtonMessage::new, BlastFurnaceRemovingCTGUIButtonMessage::handler);
	}
