...
public class RecipeGeneratorMod {
	public static final Logger LOGGER = LogManager.getLogger(RecipeGeneratorMod.class);
	public static final String MODID = "recipe_generator";

	public RecipeGeneratorMod(FMLJavaModLoadingContext context) {
		// Start of user code block mod constructor
		// End of user code block mod constructor
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = context.getModEventBus();

		RecipeGeneratorModItems.REGISTRY.register(bus);

		RecipeGeneratorModTabs.REGISTRY.register(bus);

		RecipeGeneratorModMenus.REGISTRY.register(bus);
