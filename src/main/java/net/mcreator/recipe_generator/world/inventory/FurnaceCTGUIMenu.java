...
<<<<<<< HEAD:src/main/java/net/mcreator/recipe_generator/world/inventory/FurnaceCTGUIMenu.java
...
>>>>>>> parent of f1b7d96 (fix and upgrade to 1.20.6):src/main/java/net/mcreator/justctgui/world/inventory/FurnaceCTGUIMenu.java
...
public class FurnaceCTGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public FurnaceCTGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RecipeGeneratorModMenus.FURNACE_CTGUI.get(), id);
...
<<<<<<< HEAD:src/main/java/net/mcreator/recipe_generator/world/inventory/FurnaceCTGUIMenu.java
			RecipeGeneratorMod.PACKET_HANDLER.sendToServer(new FurnaceCTGUISlotMessage(slotid, x, y, z, ctype, meta));
=======
