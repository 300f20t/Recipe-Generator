...
<<<<<<< HEAD:src/main/java/net/mcreator/recipe_generator/world/inventory/BlastFurnaceCTGUIMenu.java
...
>>>>>>> parent of f1b7d96 (fix and upgrade to 1.20.6):src/main/java/net/mcreator/justctgui/world/inventory/BlastFurnaceCTGUIMenu.java
...
public class BlastFurnaceCTGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public BlastFurnaceCTGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RecipeGeneratorModMenus.BLAST_FURNACE_CTGUI.get(), id);
...
=======
			PacketDistributor.SERVER.noArg().send(new BlastFurnaceCTGUISlotMessage(slotid, x, y, z, ctype, meta));
>>>>>>> parent of f1b7d96 (fix and upgrade to 1.20.6):src/main/java/net/mcreator/justctgui/world/inventory/BlastFurnaceCTGUIMenu.java
