...
import net.mcreator.recipe_generator.network.SmithingRGUISlotMessage;
...
public class SmithingRGUIMenu extends AbstractContainerMenu implements RecipeGeneratorModMenus.MenuAccessor {
	...
	public SmithingRGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(RecipeGeneratorModMenus.SMITHING_RGUI.get(), id);
		...
		this.customSlots.put(0, this.addSlot(new SlotItemHandler(internal, 0, 25, 35) {
			...
			public boolean mayPlace(ItemStack stack) {
				return stack.is(ItemTags.create(new ResourceLocation("neoforge:trims")));
			}
		}));
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			RecipeGeneratorMod.PACKET_HANDLER.sendToServer(new SmithingRGUISlotMessage(slotid, x, y, z, ctype, meta));
			SmithingRGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
