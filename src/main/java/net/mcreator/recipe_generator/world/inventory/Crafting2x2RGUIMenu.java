...
import net.mcreator.recipe_generator.network.Crafting2x2RGUISlotMessage;
...
public class Crafting2x2RGUIMenu extends AbstractContainerMenu implements RecipeGeneratorModMenus.MenuAccessor {
	...
	public Crafting2x2RGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			RecipeGeneratorMod.PACKET_HANDLER.sendToServer(new Crafting2x2RGUISlotMessage(slotid, x, y, z, ctype, meta));
			Crafting2x2RGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
