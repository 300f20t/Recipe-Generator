...
public class RecipeGeneratorModScreens {
	...
	public static void clientLoad(FMLClientSetupEvent event) {
		event.enqueueWork(() -> {
			...
			MenuScreens.register(RecipeGeneratorModMenus.COOSING_RGUI_OF_BLOCK_GUI.get(), CoosingRGUIOfBlockGUIScreen::new);
			MenuScreens.register(RecipeGeneratorModMenus.CRAFTING_2X_2_RGUI.get(), Crafting2x2RGUIScreen::new);
		});
	}
