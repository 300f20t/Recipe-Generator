...
public class CraftingTableRecipeGeneratorUI {
    ...
    private void createButtons() {
        buttons.add(RecipeGeneratorUI.createButton("Generate", centerX + 95, centerY - 70, this::generate));
        buttons.add(RecipeGeneratorUI.createButton("Save", centerX + 95, centerY - 45, this::save));
        buttons.add(RecipeGeneratorUI.createButton("Reload", centerX + 95, centerY - 20, this::reload));
