...
The Recipe Generator mod provides a visual recipe editor in minecraft using various recipe generation methods such as: **CraftTweaker**, **KubeJS(WIP)**, **Datapack**(WIP) or **Custom Mod**(WIP). [List of supported blocks](SupportedBlocks.md)
